...
Публичные options Field-декораторов очищены от служебных параметров. При обновлении проекта нужно проверить места, где параметры Field-декораторов задавались вручную или где проектный код напрямую читал steroids metadata.
